...
Le but de cette section est de fournir une paramétrisation bien contrôlée
d'une variété projective plongée de façon adaptée. Les applications
\( \pmnum_\dv \) et \( \pmden \) étant linéaires, il nous suffit d'étudier leur
comportement sur une base ; nous choisirons la base monomiale évidente.

Dans un premier temps, nous construirons des applications partielles,
restreintes à la partie homogène de degré \( 1 \) de l'espace de départ (dont
une base est tout simplement l'ensemble des variables), que nous noterons
