...
\begin{lem}
  ...
  \), on a :
  \worknote{Le lemme précédent n'est pas une spécialisation de celui-ci. Il
    faut donc le dire et changer de notations à un moment. Ou alors être plus
    précis ici, mais y'a du boulot.}
  \begin{enumthm}
    \item \(
        \deg \pmnum^\derp_\dv (\anyvp^\ip)
        = \deg \pmden^\derp (\anyvp^\ip)
