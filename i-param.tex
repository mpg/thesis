...
\begin{lem} \label{l:par-anyvar-mono}
  Soit \( \ip \in \N^{\dimp*} \) et \( M = \prod\limits\indrange
  ...
  \begin{enumthm}
    \item \( P^\derp_{\ip, \dv}
        = \pdiff^\derp(M)
        \cdot \vp[\anydim]^{\lgr\ip} \pden^{\lgr\kappa} \) est un polynôme ;
...
cherche à représenter par des morphismes \( \pmor*_\dv \) faisant commuter le
diagramme
