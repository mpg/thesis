...
\begin{thm}[\bsc{Faltings}] \label{t-fal2}
  ...
  $\va(\cdn)$ tels que
  \begin{equation}
    0 < \distv{\point}{V} \le \haut{\point}^{-\eps}
    \pmm,
    \label{e-has}
  \end{equation}
...
exceptionnelles n'est telle que $\haut{x_1} > c_1$ et
$\haut{x_i} > c_2 \cdot \haut{x_{i-1}}$ pour tout $i > 1$.
...
explicite de l'ex-conjecture de \bsc{Mordel-Lang}. Enfin, \bsc{Farhi}
