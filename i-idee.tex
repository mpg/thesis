...
d'approximation \1{e:has}. Ainsi que le fait remarquer \bsc{Faltings}
...
rationnels satisfaisant à \1{e:has} (que nous appellerons à l'occasion
...
d'approximation \1{e:has} ci-dessus, ou une autre condition pour
...
\begin{thm} \1{t:mumford}
  ...
  \1{e:has} ci-dessus. Il existe des constantes $\phi$, $\rho$ et $B$
  telles que si
  \begin{enumthm}
...
\1{e:has}, de la dimension et de a hauteur de $\va$, ainsi que la dimension
...
$\vai$ ; ce qui établit le théorème~\1{t:mumford}.
...
\1{e:has} et aux trois conditions suivantes :
\begin{enumthm}
...
d'approximation \1{e:has} qui établit la contrainte nécessaire en liant
...
\worknote[later]{préciser la hauteur utilisée}
