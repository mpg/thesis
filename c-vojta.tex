...
\begin{proof}
  ...
  \end{equation}
  qui montre immédiatement la dernière assertion, car la somme est vide si \(
...
\begin{proof}
  ...
  la page~89 de~\cite{phidg} qu'on interprète ainsi :
  \begin{equation}
  ...
  de~\cite[p. 85-86]{phidg} utilisés ci-dessus s'appliquent pas, car ce
  ...
  \( (\rmclab{a}{b}{\clmap}[\ind])\indrange \) donnée par les
  ...
  bihomogène de bidegré \( (2\delta a^2, 2\delta b^2) \) en \( (\vmp[1],
    \vmp[2]) \), comme une forme bihomogène de \( (2a^2, 2\beta^2) \) en la
  famille des monômes de bidegré \( (\delta, \delta) \) en \( (\vmp[1], \vmp[2])
  \), image qu'on note provisoirement \( K_\beta \). La famille des \( K_\beta
  \) représente le morphisme \( (x, y) \mapsto ax - by \) dans le plongement
  de \bsc{Veronese} non remodelé.

  La famille correspondante dans le plongement remodelé, notée \( (\rmclab
    ab\clmap[\chi, \beta])_\beta \),  s'en déduit en
  ...
  \(
    ...
    \cdot (\dimp + 1)^{5\delta \dv/2} \cdot \delta^{\dimp \dpv}
  ...
  \begin{align}
    ...
    \pmm.
  \end{align}
  Pour en déduire la dernier point, il ne reste plus qu'à prendre le produit
