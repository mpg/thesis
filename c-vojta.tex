...
précédente sont tous définis et inversibles en \( \cex \) grâces aux
différents choix d'indice et au scolie~\ref{s:part-cases}, une nouvelle
...
\end{align}
% XXX
Pour le facteur suivant, grâce au choix des formules \( \wembcl[\place] \), on
a immédiatement
\begin{equation}
  \prod_\place
  \left(
