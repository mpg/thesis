...
\begin{proof}
  ...
  Par ailleurs, les comparaisons~\ref{e:plin-norm} donnent immédiatement
  \begin{equation}
  ...
  peut-être~\ref{e:clab-norm} et~\ref{e:clab-loc}. Montrons que ces deux
...
\begin{proof}
  ...
  \). Il s'agit de vérifier que les hypothèses du corollaire impliquent bien
  celles du théorème.
