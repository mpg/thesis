...
\begin{lem}
  Soit $\anyvar \embedin \proj\dimp$ un sous-schéma fermé intègre, et $\chi
  \in \GL_{\dimp*}(\Qbar)$ donné par une matrice à coefficients entiers dans
  l'intervalle $[-B, B]$, où $B$ est un réel positif fixé, alors
  \begin{equation}
    \hautm[1]{\chi(\anyvar)}
    \le
    \hautm[1]{\anyvar}
