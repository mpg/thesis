...
\begin{proof}
  Il s'agit en fait de compléter\footnote{On contrôle en fait le développement
    ...
    fixé. Plus précisément, on peut retrouver l'énoncé de \bsc{Rémond} par
    évaluation de \( P_\dv^\derp \) et \( \pden \) en un point convenable.} la
  preuve du lemme~6.1 de \cite{remivds}, en utilisant aux places
  archimédiennes une généralisation de \cite[relation~2.3.1, p.~63]{farhith}.
