...
\begin{lem}
  ...
  les point de coordonnées homogènes \( (1: 0 : \cdots : 0) \) et \( \divi \)
  un hyperplan ne contenant pas \( p_0 \).  Il existe un plongement \( \vaemb'
    \colon \va \to \projd \) dans lequel \( \divi \) admet \( \vp[0] = 0 \)
  comme équation et tel que :
  \begin{enumthm}
    \item \(
  ...
  \begin{enumthm} \setcounter{enumi}3
    ...
    \item \(
        ...
        =
        \hmclab[\vaemb]*
        \cdot \distv[\place, \vaemb]{\divi}{p_0}^{-5/2}
        \, (\dimp + 1)^{5\dv/2}
      \) ; \label{i:plin-hmclab}
    \item \(
        \hlclab[\vaemb']
...
\begin{proof}
  ...
  de suite que \( \distv[\place, \vaemb]{\divi}{p_0} = \nv2 L ^{-1} \le \nv1 L
    ^{-1} \sqrt{\dimp+1}^\dv \). Ainsi, pour avoir les points~\ref{i:plin-dv}
  et~\ref{i:plin-hmclab}, il suffit de prouver respectivement
  \(
    \distv[\place, \vaemb']{x}{\divi}
    \le
    \distv[\place, \vaemb]{x}{\divi}
  ...
  conditions sont satisfaites avec \( \hmclab[\vaemb'] = \hmclab[\vaemb] \cdot
    \nv1 L ^{5/2} \) comme annoncé.
  ...
  \end{align}
  qui implique les deux derniers points de l'énoncé.
