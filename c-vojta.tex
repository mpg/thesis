...
\begin{lem}
  ...
  un hyperplan d'équation \( L(X) = 0 \) dans ce plongement, où \( L \) est
  normalisée de sorte qu'un de ses coefficients soit égal à \( 1 \).  Alors il
  existe un plongement \( \Theta' \colon \va \to \projd \) dans lequel \( E \)
  admet \( \vp[0] = 0 \) comme équation et tel que :
  \begin{enumthm}
    \item \(
