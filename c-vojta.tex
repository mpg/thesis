...
\begin{thm} \label{t:vojta-div}
  ...
  \begin{align}
    ...
    \\
    \newcst[\Theta]{vs-ht}
    & = \max( \hautl1{ \chow\va }, \hlclab, \htcmp, \dimp\ln(\dimp + 1) )
  \end{align}
\end{thm}
...
\begin{prop} \label{p:varset-notmin}
  ...
  \begin{align}
    ...
    \Biggl(
      6 \sum_{\fcti=1}^\puiss \wtw[\fcti] \wts[\fcti] \hautl1{\varfc[\fcti]}
...
\begin{proof}[\proofname\ du théorème~\vref{t:vojta-div}]
  ...
  \begin{align}
    ...
    + \deg T \Bigl(
      \hautl1{ \varfc* } + \frac12 \dimp\genre B
    \Bigr)
  ...
  \begin{align}
    ...
    \Bigl(
      \sum_{\fcti=1}^\puiss \wtw[\fcti] \wts[\fcti] \hautl1{\varfc[\fcti]}
...
\begin{proof}
  ...
  \begin{equation}
    ...
    \le
    \htcmp[\vaemb] + \hautl2 L + \frac12 \ln(\dimp + 1)
  \end{equation}
...
\begin{coro} \label{c:vojta-div-dv}
  ...
  \begin{align}
    ...
    & = \max \bigl(
      \hautl1{\va} + \hautl1{ E } (\genre+1) \deg \va,
      \hlclab + \frac52 \hautl1 E,
      \\ & \qquad
      \htcmp + \hautl2 E + \frac12 \ln(\dimp + 1),
      \dimp\ln(\dimp + 1)
    \bigr)
    \pmm.
  \end{align}
...
\begin{coro} \label{c:vojta-hs}
  ...
  \begin{align}
    ...
    & =
    \Delta \max \bigl(
      \Delta^\genre \hautl1{\va}, \hlclab, \htcmp
    \bigr)
    + (\genre + 1) \deg \va
    \bigl(
      \Delta^\genre \hautl1 F
...
\begin{proof}
  ...
  On pose alors \( Q = \lambda_1 P_1 + \dots + \lambda_s P_s \) et \( F =
    ...
    \hautl1{\lambda} \le \ln s + \ln(\puiss/2) \), ce qui donne
  immédiatement
  \begin{equation}
    \hautl1 F
    \le
