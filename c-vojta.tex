...
Il nous faudra représenter ce morphisme par des familles de polynômes. Pour
...
\( \ex \), est constituée d'un ouvert \( \ex \in \opdef \subset \var \) et
d'une famille de formes multihomogènes définissant un morphisme \( \wemba \)
...
\end{equation}
et en particulier, que \( \pi \circ \wemba \) soit bien défini. En bas, \(
  \ideala{\wemb(\var)} \) désigne l'idéal de l'image dans les coordonnées
indiquées.
