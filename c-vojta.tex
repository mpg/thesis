...
\begin{comment}
On peut d'ailleurs donner une autre présentation de la même notion.
Introduisons, pour tout réel positif \( \beta \), l'idéal \( \vanish*[\beta]
\) des formes \( H \) telles que \( \inda* H \ge \beta \).
