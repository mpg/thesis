...
\begin{equation}
  ...
  \nv2{ x }^\Delta
\end{equation}
d'après la formule multinomiale. Par ailleurs, aux places ultramétriques, si
l'on choisit un indice \( \ind \) tel que \( \av{ x_\ind } \) soit maximal, il
n'est pas difficile de constater que \( x_\ind^\Delta \) est une coordonnée de
\( \chi_\Delta(x) \) qui est aussi de valeur absolue maximal. On a ainsi
\begin{equation}
  \nv2{ \chi_\Delta(x) }
  =
  \nv2{ x }^\Delta
...
\begin{lem} \label{l:norm-mn}
  ...
  Par ailleurs, on a \( \sum_\place \degv \dpv \le 2\Delta / \ln \Delta \).
...
\begin{proof}
  ...
  \begin{align}
    ...
    \pmm.
  \end{align}
  Pour en déduire le dernier point, il ne reste plus qu'à prendre le
  logarithme puis la somme pondérée sur les différentes places en utilisant à
  nouveau le lemme précédent pour la somme des \( \dpv \).
\end{proof}
  ...
  \begin{align}
    ...
    & = \max \bigl(
      ...
      + \bigl(
        ...
        + \Delta^\genre (\hautl[1]{ F } + \Delta\dimp)
      \bigr) (\genre+1) \deg \va,
      \\ & \qquad
      \Delta \hlclab + 3 \Delta \dimp + \frac52 \dimp \ln \Delta
      + \frac52 (\hautl[1] F + \Delta\dimp)
      \\ & \qquad
      \Delta \htcmp
      + \hautl[2] F + \Delta\dimp
      + \frac\Delta2 \ln(\dimp),
      \\ & \qquad
