...
\begin{prop} \label{p:varset-notmin}
  ...
  \begin{align}
    ...
    \Biggl(
      3 \sum_{\fcti=1}^\puiss \wtw[\fcti] \wts[\fcti] \hautl[1]{\var[\fcti]}
...
\begin{proof}[\proofname\ du théorème~\ref{t:vojta-div}]
  ...
  \begin{align}
    ...
    \Biggl(
      4 \sum_{\fcti=1}^\puiss \wtw[\fcti] \wts[\fcti] \hautl[1]{\var[\fcti]}
      + 3 \wts[1] \cst{vs-ht} \Lambda^{(1 + \frac1\puiss) f(\vdim)}
    \Biggr)
    \label{e:vs-ht-rec}
  \end{align}
  ...
  puis~\eqref{e:varset-deg} sous la forme \( 7 \genre B \le \Lambda^{f(u)}
  \), pour obtenir :
  \begin{align}
