...
\begin{proof}
  ...
  comme une forme linéaire en \( Y = (Y_\alpha)_\alpha \) (où \( \alpha \)
  parcourt l'ensemble des \( (\dimp + 1) \)-uplets de longueur \( \delta \)),
  en faisant le changement de variable \( Y_\alpha = X^\alpha \). On note \( L
    = \sum l_\alpha Y_\alpha \) la forme linéaire obtenue, puis \( L' =
    l_\alpha \binom\delta\alpha^{-1/2} Y_\alpha \). Par construction, \( L' \)
