...
\begin{thm} \label{t:vojta-div}
  ...
  \end{align}
  avec
  \nomuse \Vbig {Dans le théorème~\vref{t:vojta-div}, minore la hauteur du plus
  petit point}
  \nomuse \Vfar {Dans le théorème~\vref{t:vojta-div}, minore l'écart
    multiplicatif entre les points}
  \nomuse \Vcos {Dans le théorème~\vref{t:vojta-div}, contrôle l'angle entre
    les points}
  \nomuse m [chap] {cardinal de la famille d'approximations \( (\ex*) \)
    considérée}
  \begin{align}
    \label{e:def-Vbig}
