...
\begin{coro} \label{c:hmat-relim}
  ...
  colonnes de la matrice de \( \relim \) dans les bases monomiales canoniques
  ont leur norme \( \nv1\truc \) majorée par
  \begin{equation}
    \prod\fctrange
    \nv1{ N'_\fct }^{\vdeg*}
...
nous établirons plus tard une version asymptotique (quand \( \beta \) tend
vers l'infini) de cette réciproque en utilisant un morphisme de réduction qui
