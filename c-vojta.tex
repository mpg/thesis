...
représentation locale, définie sur un ouvert \( \opdef \),  de \( \wemb \)
...
\begin{align} \label{e:def-ftarget}
  ...
  & \to
  \ftarget =
  \bigoplus_{\clmap \in \clmaps} \bigl(
    \cdn[\vmp]^{C'''}_\Dir
...
que \( \card \clmaps = \dimp + 1 \) d'après le lemme~\ref{l:hclab}, on a
immédiatement
\begin{equation}
  \dim \ftarget
  \le
