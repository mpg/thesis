...
restent valables et bien sûr \( \wembclv* (\cexa[\fcti],
...
\begin{align}
  ...
  \left(
    \frac{ \wembclv[][\indiv](\vmp) }{ \wembclv[][\indig](\vmp) }
  \right) ^{ \delta }
  \left(
...
\end{align}
Pour le facteur suivant, les définitions de \( \wembclv* \) et de
...
\begin{equation}
  \nv1{ R(\vmp) \cdot F( \vmp, \wembclv[](\vmp) ) }
  \le
  \nv1{ F }
  \prod\fctirange \nv1{ \wembclv* }^\delta
  \cdot \expb^{o(\delta)}
