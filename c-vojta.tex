...
d'équations linéaires exprimant l'appartenance à $\vanish + \varida$. Il est en
...
un sous-espace de $\cdn[\vmp]_\Di$ dans lequel $\vanish + \varida$
...
\begin{equation}
  ...
  \pmm,
\end{equation}
ce qui implique que $R \cdot \wemba(F) \in \vanish + \varida$ car
\begin{equation}
  R \cdot \wemba(F)
  - \rdiv^\Dir(\relim(\rdiv^\Di(\wemba(F))))
  \in \varida
  \subset \vanish + \varida
  \pmm.
\end{equation}
