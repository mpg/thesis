...
dont on prouve ou rappelle l'existence sous ces hypothèses. On discutera
ensuite de la possibilité d'expliciter certaines d'entre elles dans certains
cas.

, avant d'en donner
parfois des valeurs explicites dans le cas particulier où d'un plongement de
\bsc{Mumford} modifié tel que défini dans~\cite{daphimhva2}.
