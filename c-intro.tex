...
\begin{align} \label{e:maj-stoll}
  ...
  &
  \stoll n & \le \frac{(n+1) \log(n+1)}2 \le n \log(n+1)
\end{align}
...
Par ailleurs, les différentes constantes introduites ici, ainsi que la
quantité \( \hautl1 \va \) qui sera utilisée plusieurs fois, ne sont pas
exemptes de liens entre elles : par exemple, il est facile de majorer \(
  \hautl1 \va \) en fonction de \( \htcmp \) en
