...
ces deux notions. Tout d'abord, dans le cas où \( V \) est réduite à un point
\( y \), on a \( \distv x y = \distalgv x V \) d'après \cite[p. 50]{jadotth}.
...
proposition~2.3 (p.~23) de la référence citée, de sorte que la
