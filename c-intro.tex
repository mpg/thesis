...
Nous établirons une version explicite de cette inégalité
(proposition~\vref{p:liouville}) qui, outre son intérêt propre, joue un rôle
crucial dans la preuve de nos inégalités à la \bsc{Mumford}.
...
\bsc{Faltings} \cite{faldav} pour prouver une conjecture de \bsc{Lang},
...
rappelés par exemple dans \cite{phines}.
