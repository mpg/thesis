...
liées au plongement et la section~\vref{sec:vaemb} pour ces constantes) et \(
  N \) le cardinal d'un système complet de formes représentant l'addition de
\( \va \) (voir la section~\vref{sec:vaemb}).
...
plongement de \bsc{Mumford} modifié (section~\vref{sec:vaemb}) ; on note de
...
\begin{proof}[\proofname{} de la proposition~\vref{p:dv-p2alg}.]
  Notons déjà qu'on peut supposer \( \dim \avar \ge 1 \) (donc \( n
