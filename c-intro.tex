...
associé à un fibré symétrique \( \fibre \) et tel que l'application \(
  \Gamma(\projd, \mathcal O(d)) \to \Gamma(\va, \fibre^{\otimes d}) \) soit
surjective pour tout \( d \ge 1 \) (en particulier, l'image de \( \va \) dans
ce plongement est projectivement normale). On introduit alors quelques
constantes et notations associées à ce plongement, ainsi que des indications
concernant leurs valeurs explicites dans certains cas.
