...
\begin{thm}[corollaire~\oref{c:all-intro} et scolie~\vref{s:all-intro}]
...
\begin{proof}
  ...
  \bsc{Riemann}-\bsc{Roch} abélien entraîne alors l'assertion faite sur \(
    \nclmaps \).
\end{proof}
...
contextes, en revanche seule la démonstration de l'inégalité de \bsc{Vojta}
utilise \( \hlclab \) et \( \nclmaps \) : l'inégalité de \bsc{Mumford} repose
