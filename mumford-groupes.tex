...
\cite[p.~651]{daphiminvaii}, que nous noterons $\Delta^{(\text{ét})}$ au
...
proposition~3.7 de \cite{daphiminvaii} décrit alors explicitement l'action du
...
explicite de la proposition~2.10 de \cite{falda}, disant qu'on peut définir $V$
