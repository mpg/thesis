...
explicite depuis les travaux de \bsc{David} et \bsc{Philippon}
...
$\Onv{\smash{S_{l, l'}}} \le 4^{g\dv} \Onv{\vai}^2$ et $\Onnv{\smash{S_{l, l'}}} \le
\big(4^g (n+1)^2\big)^\dv \Onv{\vai}^2$.
...
point fixé, et telles que $\Onv{S^\bullet} \le 4^{g\dv} \Onv\vai$.

\begin{fact}[\cite{remivds}, démonstration de la prop.~5.2]
  ...
  qu'en toute place $v$, $\Onnv{Q^b} \le (2^g\sqrt{n+1})^{\dv(m^2-1)}$.
\end{fact}
