...
\begin{proof}
  Il s'agit en fait de compléter la preuve du lemme~6.1 de \cite{remivds}, en
  utilisant aux places archimédiennes une généralisation de de
  \cite[relation~2.3.1, p.~63]{farhith}. On reprend toutes les notations de
  \cite{remivds}. On va contruire $P_0^\kappa$ et $P_1^\kappa$ par récurrence
...
\begin{proof}
  ...
  spécialisation de $f_Z$ qui annulle certaines variables et remplace les
...
multiplication par un entier et de différence sur $\A$. On utilise pour cela
