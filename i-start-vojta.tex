...
\begin{thm} \label{t:vojta-div}
  ...
  \end{align}
  avec
  \nomuse{\Vbig}{Une constante du théorème~\ref{t:vojta-div}}
  \nomuse{\Vfar}{Une constante du théorème~\ref{t:vojta-div}}
  \nomuse{\Vcos}{Une constante du théorème~\ref{t:vojta-div}}
  \begin{align}
    \Vbig & = \dots (\puiss)
    \\
    \Vfar & = \dots (\puiss)
...
\nomuse[\ex]{(\ex*)}[chap]{Points dont l'existence contredirait le
...
\end{align}
qui ne dépendent pas du choix de \( \ex \), de sorte que l'ensemble \( \varset
\) ne dépend de ce choix que \lat{via} la condition \( \ex \in \var \).
...
On va maintenant attacher à représenter localement ce morphisme par une
...
\end{align}
où les \( L\pexp{\wt[\fcti], \wt[\puiss]} \) sont choisies parmi les familles
