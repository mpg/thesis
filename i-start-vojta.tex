...
particulier où la variété à approcher est découpée par l'hyperplan d'équation
\( X_0 = 0 \), supposé ne pas contenir \( \va \). Nous verrons plus tard que
ce cas particulier implique le cas général.
...
\begin{thm} \label{t:vojta}
  ...
  \begin{enumthm}
    \item \(
        0 < \prod\placerange \distv{\excep*}{\divi}^{\degv}
        < \hautm{\excep*}^{-\expapx}
      \) ; \label{i:Vapx}
    \item \(
        \hautn{\excep[1]} > \Vbig
