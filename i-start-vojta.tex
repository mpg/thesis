...
\noma{e}{(\ex*)}[chap]{Points dont l'existence contredirait le
...
\begin{scho} \label{s:wt-choose}
  \noma{a}{(\wt*)}[chap]{Poids associés à \( (\ex*) \) et fixés par le
    scolie~\ref{s:wt-choose}}
  \nomg{zeta}{\zeta}[chap]{Constante proche de zéro fixée par le
    scolie~\ref{s:wt-choose}}
