...
\) à moins de savoir majorer la hauteur des approximations exceptionnelles.
Auparavant nous introduisons les notations commodes
\begin{equation}
  \apx(\avar, \eps)
  =
  \set{
...
\end{equation}
et \( \apx'(\avar, \eps) = \apx(\avar, \eps) \cap \avar(\Qbar) \).
