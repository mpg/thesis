...
\begin{proof}
  ...
  On applique le lemme~\ref{l:big-by-cone} à chacun de ces ensembles. Ainsi,
  dans les notations du lemme en question, le nombre de points satisfaisant
  les deux conditions de l'énoncé est au plus
  \begin{equation}
    \left(
      3 \sqrt\puiss
      \bigl(
