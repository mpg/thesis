...
\begin{thm} \label{t:mumford-gen}
  ...
  \begin{align}
    ...
    \Bigl(
      \hautl1 \avar
      + \adeg m^2 \bigl( \ln \adeg + \hlpm + \htcmp + \ln(n+1) \bigr)
    \Bigr)
    \quad\ \
    \label{e:Mbig-gen}
    \\
...
\begin{proof}
  ...
  \begin{equation} \label{e:addsub-dv}
    ...
    \le
    \Distv(z, z')
    \cdot \hmpm* \bigl( 5 (n + 1)^3 \bigr)^\dv
  \end{equation}
  ...
  \(
    ...
    \distv{ z }{ z' }
  \)
  pour estimer \( R_i \) en utilisant de plus~\eqref{e:pm-loc} :
  \begin{align}
    \nv2{R_i}
    & \le
    2^\dv \nnv2 F \nv2 z
  ...
  \begin{align}
    \nv*2{\sum R_i + \sum R_{ij}}
     & \le
    \nv2{F(z)}
    \cdot \hmpm* \left( \frac52 \cdot (n')^{3/2} \right)^\dv
    \distv{ z }{ z' }
     <
...
\begin{proof}
  ...
  \begin{align}
    ...
    \bigl( 2\ln \adeg + \hlpm + \htcmp + 5\ln(n+1)/4 \bigr)
    \pmm.
  \end{align}
  ...
  \begin{equation}
    ...
    \bigl( \ln \adeg + \hlpm + \htcmp + \ln(n+1) \bigr)
  \end{equation}
