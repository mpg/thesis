...
d'améliorations éventuelles de l'inégalité de \bsc{Mumford}.
...
\begin{proof}
  ...
  dans le démonstration du lemme~\ref{l:sm-deg} ; on est ici dans le cas
...
\begin{conj} \label{j:mum}
  ...
  \begin{align}
    ...
    (1+\rho) \hautn{ x_m }
  \end{align}
  alors il existe deux indices distincts \( i \) et \( j \) et deux familles \(
