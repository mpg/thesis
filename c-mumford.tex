...
que tout variété est une intersection d'hypersurfaces.
...
une approximation de qualité telle qu'elle appartiendra nécessairement à \(
  \vai \), d'après l'inégalité de \bsc{Liouville}.
...
\begin{proof}
  ...
  On a \lat{a priori} une telle famille par point \( x_j \), mais quitte à
...
\begin{proof}[\proofname{} du théorème~\vref{t:mumford-gen}.]
  ...
  où l'égalité de droite découle du fait précédent, avec \( z_k \in \avar -
    y_m \) et \( z_k + B_k \in \avar \), où \( B_k \subset \va \) est une
  sous-variété abélienne, pour tout \( k \), et \( S < m \).
