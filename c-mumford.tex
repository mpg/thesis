...
\begin{proof}
  ...
  à compter les composantes à chaque étape, on considère la quantité définie
  ...
  composantes de \( X_j \) de dimension \( \adim - k \) est au plus \(
  ...
  pas composantes de \( S_\avar \), on voit qu'il existe un \( j_1 \le 1 +
    \adeg^2 \) tel que \( X_j \) n'ai plus de composante de dimension \( \adim
  ...
  \( j_\adim \le 1 + \adeg^2 + \adeg^3 + \dots + \adeg^{\adim+1} \) tel que \(
    X_{j_\adim} \) n'ait plus aucune composante autre que celles de \( S_\avar
  \), c'est-à-dire tel que \( X_{j_\adim} = S_\avar \).
...
Cette estimation ne sera \lat{a priori} pas utile pour la suite mais est
