...
\begin{proof}
  ...
  forme de \bsc{Chow} ou, par extension, d'un distance) et plongements de
  \bsc{Segre} (et de \bsc{Veronese} remodelé), on a
  ...
  (n^2 + n)^{\dv/2} \).  On écrit alors le développement de \bsc{Taylor}
  de \( F \) :
  \begin{equation}
    F(z')
    =
