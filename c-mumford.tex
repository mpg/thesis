...
\begin{proof}[Démonstration (de la proposition~\ref{MetricOp}).]
  ...
  \sqrt2^\dv\, \cst{CMetricOp}^{-1}$, c'est-à-dire, vu que $\cst{CMetricOp} =
  (5\sqrt2\cdot N\sqrt{N+1})^\dv / \cst{Tv}$, que $\Distv (\p z, \p z') =
...
\begin{proof} \worknote{Dupliqué par le lemme \ref{l:cramer} qui
    donne aussi une estimation de hauteur, qui serait d'ailleurs peut-être
    utile ici.}
  On utilise les formules de \bsc{Cramer}. À la place archimédienne, on minore
  $\det R$ par $1$ et on majore par $(r-1)! C^{r-1}$ la norme de chaque
  cofacteur. La norme de la comatrice et donc de l'inverse est ainsi majorée
  par $(r-1)(r-1)! C^{r-1} \le r! C^r$. Aux places finies, la comatrice est à
...
\begin{proof}[Démonstration (du théorème~\ref{Mumford}).]
  En utilisant les conclusions des deux lemmes
  précédents, on montre que $\p z$ ne satisfait pas à la conclusion la
  ...
  + 2\phi + \rho\phi) \Hautn(\p x) + B$. Ces estimations contredisent la
