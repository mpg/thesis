...
\begin{proof}
  ...
  Supposons maintenant que \( W' \) est inversible. On a donc ainsi \( B' =
    ...
    \Onv{B'} \). Il existe ainsi par le lemme~\ref{ChoixI} un indice \( i_v \)
  tel que
  \begin{equation}
    \Onv{B(w_{i_v})}
    \ge
...
inégalités de \bsc{Liouville} énoncées à la section précédente.
...
\begin{proof}
  ...
  \bsc{Mordell-Weil}. On remarque de plus que l'hypothèse \ref{sect} implique
