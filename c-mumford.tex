...
\begin{proof}[Démonstration du lemme~\ref{l:dv-p-alg-gen}.]
  ...
  \begin{align*}
    ...
    / \Onv x^{ld}
    \\ & \le
    2^{ld\dv} \Onnv[v, 2] g \Onv y^{ld-k} \Onv x^k \Onv y^k
    \Distv(\p x, \p y)^k
    / \Onv x^{ld}
    \\ & \le
  ...
  puis, si \( v \) est finie, \( \Onv {g(x)} / \Onv x ^{ld} \le \Onnv[v, 2]g
    \Distv(\p x, \p y)^m \) par l'inégalité ultramétrique ; et si \( v \) est
  infinie :
  \begin{align*}
    ...
    & \phantom{\le} \qquad
    \cdot \sum_{k=0}^{ld-m} \bigl(\Distv(\p x, \p y) (n+1)^{3/2}\bigr)^k
    \pmm,
  \end{align*}
