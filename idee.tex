...
distance étant bien sûr représentée par $\av{x - \alpha}$. Le théorème~2 de
...
\else
  \expandafter \section
\fi            {Approche envisagée} \label{s-approche}
...
\cite{farhith}, et de la preuve originale de \bsc{Faltings} \cite{faldaav}. Dans
