...
Linégalité de \bsc{Mumford} peut s'énoncer de façon très similaire. Elle dit
...
\noref{Faltings91} est donc aux variétés abéliennes ce que le théorème de
...
Une preuve totalement indépandante a été publiée en 1991 par \bsc{Vojta}. Elle
...
Des versions quantitatives du théorème 1 de \noref{faltings91} ont été établies
...
explicite de l'ex-conjecture de \bsc{Mordel-Lang}. Signalons également le
chapitre~3 de la thèse de \bsc{Fahri} qui donne une version quantitative de
...
\noref{Faltings91} : on remarque que la hauteur (relative à $E$) d'un point
...
ex-conjecture de \bsc{Lang}.

Signalons qu'on connaît des versions quantitatives du théorème de \bsc{Siegel}
(\noref{???}). Par contre, à ma conaissance, la seule démonstration connue de
