...
tel que décrit dans \cite{daphimhva2}, associé à un fibré très ample et
...
Ce plongement est intéressant par deux aspects : on connaît une constante de
comparaison explicite entre les hauteurs projective et normalisée des points
(et même des variétés), et on dispose de formules explicites pour l'addition
et la soustraction. Le fait suivant est une reformulation de la
proposition~3.9 de \emph{loc. cit} et de la remarque subséquente.

\begin{fact} \label{f:comp-h-hn}
  Pour tout point \( \pp \in \va(\Qbar) \), on a
  \begin{equation}
    \abs{\hautn\pp - \hautl\pp}
    \le
    (4^\genre - 1) \hautl\va + 3\genre \ln2
    \pmm.
  \end{equation}
\end{fact}

La section suivante rappelle les formules d'addition-soustraction et en
établit plus généralement pour les combinaisons linéaires.
