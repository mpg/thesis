...
Il s'agit de trouver une forme multi-homogène non nulle sur $\var$, de degré

On pose $d = \delta \cdot (\eps_0 a_1^2, \dots, \eps_0 a_\puiss^2, 1, \dots,
1$ et on note $d' = \psi_a^{\deg}(d)$. 
